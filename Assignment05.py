...
#   ACook,2/25/2026,Created Script
# ------------------------------------------------------------------------------------------ #
...
while (True):
    ...
    if menu_choice == "1":  # This will not work if it is an integer!
        try:
            ...
            if not student_first_name.isalpha():
                raise ValueError("Invalid first name: first name should not contain numbers")
            student_last_name = input("Enter the student's last name: ")
            if not student_last_name.isalpha():
                raise ValueError("Invalid last name: last name should not contain numbers")
            ...
            print("There was an error entering the data\n")
            print("-- Technical Error Message -- ")
            print(e, e.__doc__, type(e), sep='\n')
        continue
    ...
    # Save the data to a file
        ...
        try:
            ...
            print("There was a problem saving the data to the file.\n")
            print("-- Technical Error Message -- ")
            print(e, e.__doc__, type(e), sep='\n')
        finally:
            # Check if a file object exists and is still open
